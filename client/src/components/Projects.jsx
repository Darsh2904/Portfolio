...
const FALLBACK = [
  { _id: '1', order: 1, title: 'Dreamland Travel', badge: 'Travel Tech', description: 'Full-featured travel booking platform with destination discovery, itinerary planning, and booking management. Built for scale with a seamless UX.', techStack: ['React','Node.js','MongoDB','Express'], liveUrl: 'https://dreamland-travel.netlify.app/', githubUrl: '#', accentColor: '#00f5ff', codeSnippet: "const TravelApp = () => {\n  const [trips, setTrips] = useState([])\n  return <TravelDashboard />\n}" },
